...
replyText = f"<b>👋 හායි   {mentionUser} !!\n\n 🥲 කණගාටුයි ඔබගේ ඉල්ලීම වන  {contentRequested} අද දිනයේ ලබා ගත නොහැක.\n\n🚀 අද දිනයේදී ලබා ගත හැකි ඉල්ලීම් ප්‍රමාණය ඉක්මවා ගොස් ඇත.\n📌එම නිසා මෙම ඉල්ලීම නැවත හෙට දිනයේදී ලබා දීමට උත්සහා කරන්න \n\nඔබට ගැටළු කාරී තත්ත්වක් ඇත්නම් ඇඩ්මින් කෙනෙකු සම්බන්ධ කර ගන්න.</b>"
